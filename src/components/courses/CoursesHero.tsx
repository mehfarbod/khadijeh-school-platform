  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full px-5 py-10 text-center sm:px-6">
        ...
        <p className="mx-auto max-w-[540px] text-[13px] font-normal leading-[1.9] text-[#DBE7C1]/85 sm:text-[clamp(13px,2vw,15.5px)]">
          دوره‌های آموزشی و مهارتی مدرسه را ببینید و بر اساس پایه و وضعیت
          ثبت‌نام، دوره مناسب خود را پیدا کنید.
        </p>
      </div>
    </section>
  );
